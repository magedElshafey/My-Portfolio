...
const Servies = () => {
  return (
		<div data-aos='fade-down' data-aos-offset='100' id='serv' className={`my-5 py-5 ${style.mainContainer}`}>
			<div className='container '>
				<MainTitle title='our services' question='what I Offer ? ' />
				<div className='row justify-content-center gap-5 my-5 py-5'>
					{services.map((item, index) => (
						<div key={index} className={`${style.mainBox} mb-5 mb-md-0  col-12 col-md-5 col-lg-3 position-relative`}>
							<img className={style.mainImg} alt='serv/img' src={item.img} />
							<p className='mt-5 pt-5 mb-3 text-center text-white fw-bold fs-4'>{item.title}</p>
